-- ATM version 0.0.12 --
-- Modified for TekuCraft usage by Daniel --
...
-- Define the capacity of the dropper in Netherite coins (adjust this as needed)
local dropperCapacity = 5760
...
-- Title
local title = "Teku Credit Union"

-- Location information
local location = "Main Street Branch"
...
function drawScreen(scrn)
    ...
    elseif scrn == 3 then
        ...
        term.write("Please insert your coins then click done")
    ...
    elseif scrn == 4 then
        ...
        term.write("Please enter the amount you want to withdraw")
        term.setCursorPos(21, 8)
        term.setBackgroundColor(backColor)
        term.setTextColor(colors.lightGray)
        term.write("Amm: ")
    ...
    elseif scrn == 5 then
        screen = 5
        term.setCursorPos(4, 5)
        term.write("Please enter the amount you want to transfer")
        term.setCursorPos(21, 8)
        term.setBackgroundColor(backColor)
        term.setTextColor(colors.lightGray)
        term.write("Amm: ")
...
function prosClick(butt)
    ...
    elseif screen == 4 then
        ...
        if (withMode) then
            ...
            if (isWith) then
                withMode = false
                if (tonumber(with) > dropperCapacity) then
                    api.clear(backColor, true)
                    term.setCursorPos(17, 9)
                    term.write("Amount must be at maximum " .. dropperCapacity)
                else
                    api.clear(backColor, true)
                    term.setCursorPos(17, 5)
                    term.write("Please enter your pin")
    ...
    elseif screen == 5 then
        ...
        if (trasMode) then
            ...
            if (isTras) then
                trasMode = false
                if (tonumber(tras) > dropperCapacity) then
                    api.clear(backColor, true)
                    term.setCursorPos(17, 9)
                    term.write("Amount must be at maximum " .. dropperCapacity)
                else
...
while true do
    ...
    elseif (event[1] == "mouse_click") then
        local click, but = onClick(event[3], event[4], 0)
        if (click) then
            prosClick(but)
        end
